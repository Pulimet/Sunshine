...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "net.alexandroid.sunshine";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        //content://net.alexandroid.sunshine.data/location
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        //content://net.alexandroid.sunshine.data/weather
